...
%argdel
$argadd db/seeds.rb
edit app/models/ingredient_tag.rb
...
wincmd w
argglobal
if bufexists("db/seeds.rb") | buffer db/seeds.rb | else | edit db/seeds.rb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
wincmd w
argglobal
if bufexists("db/migrate/20200217014244_create_data_and_join_tables.rb") | buffer db/migrate/20200217014244_create_data_and_join_tables.rb | else | edit db/migrate/20200217014244_create_data_and_join_tables.rb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
badd +0 db/migrate/20200217014244_create_data_and_join_tables.rb
badd +13 app/models/recipe.rb
badd +3 app/models/equipment.rb
badd +4 app/models/join_equipment_recipe.rb
badd +0 app/models/ingredient_tag.rb
