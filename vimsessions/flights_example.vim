...
silent only
silent tabonly
cd ~/odin-project/odin-flight-booker
...
argglobal
%argdel
$argadd app/controllers/bookings_controller.rb
edit app/controllers/bookings_controller.rb
...
wincmd w
argglobal
if bufexists("app/views/flights/index.html.erb") | buffer app/views/flights/index.html.erb | else | edit app/views/flights/index.html.erb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((13 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
wincmd w
argglobal
if bufexists("app/views/bookings/new.html.erb") | buffer app/views/bookings/new.html.erb | else | edit app/views/bookings/new.html.erb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
exe 'vert 3resize ' . ((&columns * 83 + 83) / 167)
tabnext 1
badd +0 app/controllers/bookings_controller.rb
badd +0 app/views/bookings/new.html.erb
badd +0 app/views/flights/index.html.erb
badd +16 app/controllers/flights_controller.rb
