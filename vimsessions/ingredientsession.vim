...
%argdel
$argadd db/seeds.rb
edit app/views/ingredients/index.html.erb
...
wincmd w
argglobal
if bufexists("app/views/ingredients/edit.html.erb") | buffer app/views/ingredients/edit.html.erb | else | edit app/views/ingredients/edit.html.erb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
wincmd w
argglobal
if bufexists("app/controllers/ingredients_controller.rb") | buffer app/controllers/ingredients_controller.rb | else | edit app/controllers/ingredients_controller.rb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 41 - ((13 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
wincmd w
argglobal
if bufexists("app/models/ingredient.rb") | buffer app/models/ingredient.rb | else | edit app/models/ingredient.rb | endif
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
let &cpo=s:cpo_save
...
badd +1 app/models/ingredient.rb
badd +17 db/migrate/20200217014244_create_data_and_join_tables.rb
badd +11 app/models/recipe.rb
badd +3 app/models/equipment.rb
badd +4 app/models/join_equipment_recipe.rb
badd +4 app/models/ingredient_tag.rb
badd +32 app/views/recipes/edit.html.erb
badd +58 app/controllers/recipes_controller.rb
badd +1 app/views/layouts/application.html.erb
badd +15 app/assets/javascripts/application.js
badd +12 config/routes.rb
badd +12 app/views/recipes/show.html.erb
badd +3 app/views/recipes/index.html.erb
badd +1 app/views/shared/_recipe_link.html.erb
badd +2 app/controllers/equipment_controller.rb
badd +1 app/views/ingredients/edit.html.erb
badd +1 app/views/ingredients/index.html.erb
badd +6 app/views/equipment/index.html.erb
badd +1 app/controllers/ingredient_tags_controller.rb
badd +0 app/controllers/ingredients_controller.rb
